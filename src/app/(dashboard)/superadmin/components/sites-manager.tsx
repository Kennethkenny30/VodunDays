              ...
              <div className="space-y-5">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent side="right" className="text-xs max-w-[240px]">
                        Capture votre position GPS en temps réel. Pour une précision optimale, activez le GPS de votre appareil et placez-vous à l'endroit exact du site.
                      </TooltipContent>
                    </Tooltip>
                  </div>

                  <p className="text-xs text-muted-foreground/70 leading-relaxed">
                    📍 <strong>Pour une localisation précise :</strong> rendez-vous physiquement sur le site, activez le GPS de votre appareil, puis cliquez sur le bouton ci-dessous.
                  </p>
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <a
                          ...
                          className="ml-auto text-[10px] text-[var(--vd-gold)]/70 hover:text-[var(--vd-gold)] transition-colors underline underline-offset-2"
                        >
                          Vérifier sur Maps
                        </a>
                      </TooltipTrigger>
                ...
                <div className="rounded-xl border border-white/8 bg-white/3 p-4 space-y-2">
                  ...
                  <ul className="space-y-1.5 text-xs text-muted-foreground/70">
                    ...
                    <li className="flex gap-2"><span className="text-[var(--vd-gold)] shrink-0">4.</span> Cliquez sur "Capturer ma position GPS" ci-dessus</li>
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent side="top" className="text-xs">
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-[var(--vd-gold)] underline"
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <DropdownMenuItem asChild>
                            <a
                              ...
                              rel="noopener noreferrer"
                            >
                              <MapPin className="mr-2 size-4" /> Voir sur carte
                            </a>
                          </DropdownMenuItem>
                          <ConfirmDialog
